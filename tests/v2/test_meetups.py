...
#         response = self.client.post("api/v1/meetups", data = json.dumps(self.meetups_topic), headers={'x-access-token': self.token}, content_type = "application/json")
...
#         """
#         self.token = self.login()
#         response = self.client.post("api/v1/meetups", data = json.dumps(self.meetups_meetup_date), headers={'x-access-token': self.token}, content_type = "application/json")
#         result = json.loads(response.data.decode('utf-8'))
#         self.assertEqual(response.status_code, 400)
#         self.assertEqual(result["status"], 400)
...
#         """
#         self.token = self.login()
#         response = self.client.post("api/v1/meetups", data = json.dumps(self.meetups_tags), headers={'x-access-token': self.token}, content_type = "application/json")
#         result = json.loads(response.data.decode('utf-8'))
#         self.assertEqual(response.status_code, 400)
#         self.assertEqual(result["status"], 400)
...
#         """
#         self.token = self.login()
#         response = self.client.post("api/v1/meetups", data = json.dumps(self.meetups_location), headers={'x-access-token': self.token}, content_type = "application/json")
#         result = json.loads(response.data.decode('utf-8'))
#         self.assertEqual(response.status_code, 400)
#         self.assertEqual(result["status"], 400)
...
#         self.token = self.login()
#         self.client.post("api/v1/meetups", data = json.dumps(self.post_meetup1), headers={'x-access-token': self.token}, content_type = "application/json")
#         response = self.client.delete("api/v1/meetups/10", headers={'x-access-token': self.token}, content_type = "application/json")
#         result = json.loads(response.data.decode('utf-8'))
